...
return [
    ...
    'fields' => [
        ...
        'sendmail_search_words' => 'إرسال بريد إلكتروني في حالة العثور على إحدى الكلمات المحددة في الناتج',
        'search_words' => 'البحث عن هذه الكلمات في الناتج',
        'search_words_helptext' => 'كلمة واحدة أو مصطلح بحث واحد في كل سطر (بدون حدود)',
