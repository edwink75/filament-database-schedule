...
return [
    ...
    'fields' => [
        ...
        'sendmail_search_words' => 'Send email in case one of the specified words is found in the output',
        'search_words' => 'Search output for these words',
        'search_words_helptext' => 'One word or search term per line (no limit)',
